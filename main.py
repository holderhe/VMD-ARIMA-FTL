...
if __name__ == '__main__':
	...
	# clusters_norm_plus = {
	# 	0: {
	# 		0: ['DE_KN_residential3_washing_machine', 'DE_KN_residential2_washing_machine', 'DE_KN_residential1_washing_machine', 'DE_KN_residential4_washing_machine', 'DE_KN_residential6_washing_machine', 'DE_KN_residential5_washing_machine']},
	# 	1: {
	# 		0: ['DE_KN_residential3_washing_machine', 'DE_KN_residential2_washing_machine', 'DE_KN_residential1_washing_machine', 'DE_KN_residential4_washing_machine', 'DE_KN_residential6_washing_machine', 'DE_KN_residential5_washing_machine']},
	# 	2: {
	# 		0: ['DE_KN_residential3_washing_machine', 'DE_KN_residential2_washing_machine', 'DE_KN_residential1_washing_machine', 'DE_KN_residential4_washing_machine', 'DE_KN_residential6_washing_machine', 'DE_KN_residential5_washing_machine']},
	...
	# 		0: ['DE_KN_residential3_washing_machine', 'DE_KN_residential2_washing_machine', 'DE_KN_residential1_washing_machine', 'DE_KN_residential4_washing_machine', 'DE_KN_residential6_washing_machine', 'DE_KN_residential5_washing_machine']},
	# 	4: {
	# 		0: ['DE_KN_residential3_washing_machine', 'DE_KN_residential2_washing_machine',
	# 		    'DE_KN_residential1_washing_machine', 'DE_KN_residential4_washing_machine',
	# 		    'DE_KN_residential6_washing_machine', 'DE_KN_residential5_washing_machine']},
	# 	5: {
	# 		0: ['DE_KN_residential3_washing_machine', 'DE_KN_residential2_washing_machine',
	# 		    'DE_KN_residential1_washing_machine', 'DE_KN_residential4_washing_machine',
	# 		    'DE_KN_residential6_washing_machine', 'DE_KN_residential5_washing_machine']},
	...
	# }
	# pqs = {
	# 	'DE_KN_residential1_washing_machine': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 1), 'c'), 2: ((1, 0, 1), 'c'), 3: ((1, 0, 1), 'c'), 4: ((0, 0, 4), 'c'), 5: ((1, 0, 2), 'c'), 6: ((1, 0, 3), 'n'), 7: ((1, 0, 3), 'c'), 8: ((8, 0, 0), 'c'), 9: ((6, 0, 1), 'c'), 10: ((37, 0, 2), 'n')}, 'DE_KN_residential2_washing_machine': {0: ((1, 1, 5), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'c'), 3: ((0, 0, 4), 'c'), 4: ((0, 0, 4), 'c'), 5: ((1, 0, 3), 'n'), 6: ((1, 0, 2), 'n'), 7: ((1, 0, 1), 'c'), 8: ((0, 0, 1), 'n'), 9: ((6, 0, 2), 'n'), 10: ((29, 0, 0), 'c')}, 'DE_KN_residential3_washing_machine': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 2), 'n'), 2: ((1, 0, 1), 'c'), 3: ((1, 0, 1), 'c'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'c'), 6: ((1, 0, 1), 'c'), 7: ((1, 0, 2), 'n'), 8: ((10, 0, 0), 'c'), 9: ((5, 0, 1), 'c'), 10: ((19, 0, 2), 'c')}, 'DE_KN_residential4_washing_machine': {0: ((1, 1, 5), 'n'), 1: ((1, 0, 1), 'c'), 2: ((1, 0, 4), 'n'), 3: ((1, 0, 4), 'n'), 4: ((1, 0, 4), 'n'), 5: ((1, 0, 4), 'n'), 6: ((1, 0, 4), 'n'), 7: ((1, 0, 3), 'n'), 8: ((1, 0, 1), 'c'), 9: ((0, 0, 1), 'n'), 10: ((2, 0, 0), 'n')}, 'DE_KN_residential5_washing_machine': {0: ((1, 1, 2), 'n'), 1: ((1, 0, 1), 'c'), 2: ((1, 0, 1), 'c'), 3: ((1, 0, 1), 'c'), 4: ((1, 0, 3), 'n'), 5: ((1, 0, 3), 'n'), 6: ((1, 0, 3), 'n'), 7: ((1, 0, 3), 'c'), 8: ((5, 0, 4), 'c'), 9: ((6, 0, 4), 'c'), 10: ((1, 0, 1), 'n')}, 'DE_KN_residential6_washing_machine': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 2), 'c'), 2: ((1, 0, 5), 'c'), 3: ((1, 0, 5), 'c'), 4: ((1, 0, 5), 'c'), 5: ((1, 0, 5), 'n'), 6: ((1, 0, 4), 'n'), 7: ((1, 0, 3), 'n'), 8: ((1, 0, 1), 'c'), 9: ((7, 0, 2), 'c'), 10: ((1, 0, 7), 'c')}
	# }
	...
	# pqs = {
	# 	'DE_KN_industrial1_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 0), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((0, 0, 2), 'n'), 7: ((2, 0, 5), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 2), 'n'), 10: ((3, 0, 1), 'c'), 11: ((6, 0, 0), 'c'), 12: ((6, 0, 2), 'c')}, 'DE_KN_industrial2_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 2), 'c'), 4: ((1, 0, 1), 'c'), 5: ((0, 0, 5), 'c'), 6: ((1, 0, 1), 'c'), 7: ((0, 0, 2), 'n'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 3), 'c'), 10: ((5, 0, 2), 'c'), 11: ((7, 0, 1), 'c'), 12: ((10, 0, 1), 'n')}, 'DE_KN_industrial3_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'c'), 6: ((1, 0, 1), 'n'), 7: ((1, 0, 7), 'c'), 8: ((1, 0, 5), 'n'), 9: ((5, 0, 2), 'c'), 10: ((1, 0, 4), 'c'), 11: ((4, 0, 3), 'c'), 12: ((11, 0, 0), 'n')}, 'DE_KN_public1_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 0), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'c'), 6: ((0, 0, 2), 'n'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'c'), 10: ((0, 0, 2), 'n'), 11: ((4, 0, 1), 'c'), 12: ((5, 0, 0), 'c')}, 'DE_KN_residential1_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 2), 'c'), 2: ((1, 0, 2), 'c'), 3: ((1, 0, 3), 'n'), 4: ((0, 0, 4), 'c'), 5: ((1, 0, 3), 'n'), 6: ((1, 0, 3), 'c'), 7: ((1, 0, 3), 'n'), 8: ((1, 0, 2), 'n'), 9: ((1, 0, 1), 'c'), 10: ((1, 0, 1), 'c'), 11: ((16, 0, 1), 'c'), 12: ((9, 0, 1), 'c')}, 'DE_KN_residential2_grid_import': {0: ((1, 1, 2), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 2), 'c'), 3: ((1, 0, 1), 'c'), 4: ((0, 0, 4), 'c'), 5: ((0, 0, 3), 'c'), 6: ((1, 0, 2), 'n'), 7: ((0, 0, 3), 'c'), 8: ((1, 0, 2), 'n'), 9: ((1, 0, 1), 'c'), 10: ((5, 0, 5), 'c'), 11: ((6, 0, 2), 'c'), 12: ((0, 0, 5), 'c')}, 'DE_KN_residential3_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 2), 'c'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'c'), 4: ((1, 0, 1), 'c'), 5: ((1, 0, 2), 'c'), 6: ((0, 0, 2), 'n'), 7: ((0, 0, 4), 'c'), 8: ((0, 0, 3), 'c'), 9: ((2, 0, 3), 'n'), 10: ((3, 0, 2), 'c'), 11: ((2, 0, 0), 'c'), 12: ((9, 0, 0), 'n')}, 'DE_KN_residential4_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 0), 'n'), 2: ((1, 0, 1), 'c'), 3: ((1, 0, 1), 'c'), 4: ((1, 0, 1), 'n'), 5: ((0, 0, 3), 'c'), 6: ((1, 0, 2), 'c'), 7: ((1, 0, 2), 'c'), 8: ((1, 0, 2), 'n'), 9: ((1, 0, 4), 'n'), 10: ((6, 0, 2), 'c'), 11: ((4, 0, 1), 'c'), 12: ((22, 0, 0), 'n')}, 'DE_KN_residential5_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 0), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((1, 0, 1), 'n'), 7: ((0, 0, 3), 'n'), 8: ((0, 0, 2), 'n'), 9: ((0, 0, 4), 'c'), 10: ((5, 0, 1), 'c'), 11: ((17, 0, 1), 'c'), 12: ((12, 0, 2), 'c')}, 'DE_KN_residential6_grid_import': {0: ((1, 1, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'c'), 5: ((0, 0, 2), 'n'), 6: ((0, 0, 4), 'n'), 7: ((0, 0, 3), 'n'), 8: ((1, 0, 2), 'n'), 9: ((1, 0, 1), 'c'), 10: ((3, 0, 6), 'c'), 11: ((3, 0, 0), 'c'), 12: ((15, 0, 0), 'c')}
	#        }
	# clusters_norm_plus = {
	# 		0: {
	# 			0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import', 'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import', 'DE_KN_residential5_grid_import', 'DE_KN_industrial1_grid_import', 'DE_KN_industrial3_grid_import', 'DE_KN_industrial2_grid_import', 'DE_KN_residential3_grid_import', 'DE_KN_public1_grid_import']},
	# 		1: {
	# 			0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import', 'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import', 'DE_KN_residential5_grid_import', 'DE_KN_industrial1_grid_import', 'DE_KN_industrial3_grid_import', 'DE_KN_industrial2_grid_import', 'DE_KN_residential3_grid_import', 'DE_KN_public1_grid_import']},
	# 		2: {
	# 			0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import', 'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import', 'DE_KN_residential5_grid_import', 'DE_KN_industrial1_grid_import', 'DE_KN_industrial3_grid_import', 'DE_KN_industrial2_grid_import', 'DE_KN_residential3_grid_import', 'DE_KN_public1_grid_import']},
	...
	# 			0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import', 'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import', 'DE_KN_residential5_grid_import', 'DE_KN_industrial1_grid_import', 'DE_KN_industrial3_grid_import', 'DE_KN_industrial2_grid_import', 'DE_KN_residential3_grid_import', 'DE_KN_public1_grid_import']},
	# 		9: {
	# 			0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import',
	# 			    'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import',
	# 			    'DE_KN_residential5_grid_import', 'DE_KN_industrial1_grid_import', 'DE_KN_industrial3_grid_import',
	# 			    'DE_KN_industrial2_grid_import', 'DE_KN_residential3_grid_import', 'DE_KN_public1_grid_import']},
	#
	# 	10: {0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import', 'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import', 'DE_KN_residential5_grid_import', 'DE_KN_industrial1_grid_import', 'DE_KN_industrial3_grid_import', 'DE_KN_industrial2_grid_import', 'DE_KN_residential3_grid_import', 'DE_KN_public1_grid_import']},
	#
	# 		11: {0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import', 'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import', 'DE_KN_residential5_grid_import', 'DE_KN_industrial1_grid_import', 'DE_KN_industrial3_grid_import', 'DE_KN_industrial2_grid_import', 'DE_KN_residential3_grid_import', 'DE_KN_public1_grid_import']},
	#
	# 		12: {
	# 			0: ['DE_KN_residential2_grid_import', 'DE_KN_residential1_grid_import',
	# 			    'DE_KN_residential4_grid_import', 'DE_KN_residential6_grid_import',
	...
	# k = 12  # to split up period and keep stationary
	# pqs = {
	# 	'quetta_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((1, 0, 1), 'c'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((9, 0, 1), 'c'), 11: ((6, 0, 0), 'c'), 12: ((24, 0, 2), 'c')}, 'bahawalpur_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((1, 0, 1), 'c'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((5, 0, 1), 'c'), 11: ((8, 0, 1), 'c'), 12: ((32, 0, 1), 'n')}, 'hyderabad_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((1, 0, 1), 'c'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((6, 0, 0), 'c'), 11: ((8, 0, 1), 'c'), 12: ((38, 0, 0), 'c')}, 'islamabad_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((0, 0, 2), 'n'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((4, 0, 0), 'c'), 11: ((4, 0, 0), 'c'), 12: ((22, 0, 3), 'n')}, 'karachi_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'c'), 6: ((1, 0, 1), 'c'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((5, 0, 1), 'c'), 11: ((8, 0, 1), 'c'), 12: ((34, 0, 0), 'c')}, 'khuzdar_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((0, 0, 3), 'n'), 7: ((0, 0, 2), 'n'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((14, 0, 1), 'c'), 11: ((5, 0, 1), 'c'), 12: ((34, 0, 1), 'c')}, 'lahore_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'c'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'n'), 6: ((0, 0, 3), 'n'), 7: ((0, 0, 2), 'n'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((6, 0, 1), 'c'), 11: ((3, 0, 0), 'c'), 12: ((2, 0, 5), 'c')}, 'multan_wind_speed': {0: ((1, 0, 0), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((1, 0, 1), 'c'), 6: ((1, 0, 1), 'c'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((2, 0, 1), 'c'), 11: ((6, 0, 1), 'c'), 12: ((5, 0, 2), 'n')}, 'peshawar_wind_speed': {0: ((1, 0, 1), 'n'), 1: ((1, 0, 1), 'n'), 2: ((1, 0, 1), 'n'), 3: ((1, 0, 1), 'n'), 4: ((1, 0, 1), 'n'), 5: ((0, 0, 4), 'n'), 6: ((1, 0, 1), 'c'), 7: ((1, 0, 1), 'c'), 8: ((1, 0, 1), 'c'), 9: ((1, 0, 1), 'n'), 10: ((11, 0, 1), 'c'), 11: ((5, 0, 1), 'c'), 12: ((2, 0, 3), 'n')}
	#        }
	# clusters_norm_plus = {
	# 		0: {
	# 			0: data.columns.to_list()},
	...
	# 		9: {
	# 			0: data.columns.to_list()},
	# 		10: {0: data.columns.to_list()},
	#
	# 		11: {0: data.columns.to_list()},
	# 		12: {0: data.columns.to_list()},
	#
	# 	}
